...
namespace Furiza.Audit.SqlServer.Dapper
{
    internal class AuditContext
    {
        ...
        public AuditContext(AuditConfigurationSqlServer auditConfigurationSqlServer)
        {
            ...
            connection = new SqlConnection(auditConfigurationSqlServer.SqlServer.ConnectionString);
        }
